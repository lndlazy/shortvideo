...
import com.aaron.fpvideodemo.common.utils.VideoMaterialDownloadProgress;
import com.aaron.fpvideodemo.common.utils.VideoUtil;
...
//                break;
    ...
    public Bitmap getFilterBitmapByIndex(int index) {
        ...
        switch (index) {
            case 1:
                bmp = decodeResource(getResources(), R.mipmap.filter_biaozhun);
                break;
            case 2:
                bmp = decodeResource(getResources(), R.mipmap.filter_yinghong);
                break;
            case 3:
                bmp = decodeResource(getResources(), R.mipmap.filter_yunshang);
                break;
            case 4:
                bmp = decodeResource(getResources(), R.mipmap.filter_chunzhen);
                break;
            case 5:
                bmp = decodeResource(getResources(), R.mipmap.filter_bailan);
                break;
            case 6:
                bmp = decodeResource(getResources(), R.mipmap.filter_yuanqi);
                break;
            case 7:
                bmp = decodeResource(getResources(), R.mipmap.filter_chaotuo);
                break;
            case 8:
                bmp = decodeResource(getResources(), R.mipmap.filter_xiangfen);
                break;
            case 9:
