package com.aaron.fpvideodemo.videorecord;
...
import com.aaron.fpvideodemo.mainui.videoeditor.SoundEffectsSettingPannel;
import com.aaron.fpvideodemo.mainui.videoeditor.TCBGMPannel2;
import com.aaron.fpvideodemo.videorecord.bgm.BGMSelectActivity;
...
public class VideoShootingActivity extends VideoBaseActivity implements View.OnClickListener, BeautySettingPannel.IOnBeautyParamsChangeListener
    ...
    private static final String TAG = "VideoShootingActivity";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_TAKE_PHOTO_FAIL: {
                    Toast.makeText(VideoShootingActivity.this, getResources().getString(R.string.activity_video_record_take_photo_fail), Toast.LENGTH_SHORT).show();
                    mIsTakingPhoto = true;
                    break;
                }
                default:
    ...
    private void initViews() {
            ...
            public void onTakePhotoStart() {
                ...
                if (volume != 0) {
                    if (mShootMediaPlayer == null) {
                        mShootMediaPlayer = MediaPlayer.create(VideoShootingActivity.this, Uri.parse("file:///system/media/audio/ui/camera_click.ogg"));
                    }
                    if (mShootMediaPlayer != null) {
                ...
                mTXCameraRecord.snapshot(new TXRecordCommon.ITXSnapshotListener() {
                    ...
                    public void onSnapshot(Bitmap bitmap) {
                        ...
                        MediaStore.Images.Media.insertImage(VideoShootingActivity.this.getContentResolver(), bitmap, fileName, null);
        ...
        mRbNormal.setBackground(ContextCompat.getDrawable(this, R.mipmap.record_mid_bg));
        mRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    case R.id.rb_fast:
                        mRbFast.setBackground(ContextCompat.getDrawable(VideoShootingActivity.this, R.mipmap.record_mid_bg));
                    ...
                    case R.id.rb_fastest:
                        mRbFastest.setBackground(ContextCompat.getDrawable(VideoShootingActivity.this, R.mipmap.record_right_bg));
                        ...
                        break;
                    case R.id.rb_normal:
                        mRbNormal.setBackground(ContextCompat.getDrawable(VideoShootingActivity.this, R.mipmap.record_mid_bg));
                        mRbFastest.setBackground(null);
                        mRbFast.setBackground(null);
                        mRbSlow.setBackground(null);
                        mRbSloweset.setBackground(null);
                        ...
                        break;
                    case R.id.rb_slow:
                        mRbSlow.setBackground(ContextCompat.getDrawable(VideoShootingActivity.this, R.mipmap.record_mid_bg));
                        mRbFastest.setBackground(null);
                        mRbFast.setBackground(null);
                        mRbNormal.setBackground(null);
                        mRbSloweset.setBackground(null);
                    ...
                    case R.id.rb_slowest:
                        mRbSloweset.setBackground(ContextCompat.getDrawable(VideoShootingActivity.this, R.mipmap.record_left_bg));
                        mRbFastest.setBackground(null);
                        mRbFast.setBackground(null);
                        mRbNormal.setBackground(null);
                        mRbSlow.setBackground(null);
    ...
    private void showSnapshotPhoto(Bitmap bitmap){
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Toast.makeText(VideoShootingActivity.this, getResources().getString(R.string.activity_video_record_take_photo_success),
    ...
    private void startRecord() {
        ...
        if (result != 0) {
            Toast.makeText(VideoShootingActivity.this.getApplicationContext(),
...
//        UMShareAPI.get(this).onActivityResult(requestCode, resultCode, data);
    ...
    public void onJoinComplete(TXVideoEditConstants.TXJoinerResult result) {
        ...
        if(result.retCode == TXVideoEditConstants.JOIN_RESULT_OK){
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(VideoShootingActivity.this,
    ...
    public boolean onScroll(MotionEvent downEvent, MotionEvent moveEvent, float distanceX, float distanceY) {
        ...
        if (moveRight && mCurrentIndex == 0) {
            //  Toast.makeText(VideoShootingActivity.this, "已经是第一个啦~", Toast.LENGTH_SHORT).show();
            return true;
        } else if (!moveRight && mCurrentIndex == mBeautyPannelView.getBeautyFilterArr().length - 1) {
            //Toast.makeText(VideoShootingActivity.this, "已经是最后一个啦~", Toast.LENGTH_SHORT).show();
            return true;
        } else {
            mStartScroll = true;
            if (moveRight) {//往右滑动
