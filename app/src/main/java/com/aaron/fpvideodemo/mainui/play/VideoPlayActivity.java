...
//        Logger.d("===onPlayEvent===::" + event);
        ...
        if (event == TXLiveConstants.PLAY_EVT_CHANGE_RESOLUTION) {
            ...
            Toast.makeText(VideoPlayActivity.this, "event:" + event, Toast.LENGTH_SHORT).show();
        }
    }
...
//            }
//        });
        mDownloadProgressDialog = new ProgressDialog(VideoPlayActivity.this);
...
//                ImageView iv_search = viewGroup.findViewById(R.id.iv_search);
    ...
    private void downloadVideo() {
        ...
        if (tcVideoInfo.review_status.equals(TCVideoInfo.REVIEW_STATUS_NOT_REVIEW)) {
            Toast.makeText(VideoPlayActivity.this, R.string.tc_ugc_video_list_adapter_video_state_in_audit, Toast.LENGTH_SHORT).show();
            return;
        } else if (tcVideoInfo.review_status.equals(TCVideoInfo.REVIEW_STATUS_PORN)) {
            Toast.makeText(VideoPlayActivity.this, R.string.tc_ugc_video_list_adapter_video_state_pornographic, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        DownloadUtil.get().download(tcVideoInfo.playurl, TCConstants.OUTPUT_DIR_NAME, new DownloadUtil.DownloadListener() {
            ...
            public void onDownloadFailed() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        mDownloadProgressDialog.dismiss();
                        showErr(getResources().getString(R.string.tc_vod_player_activity_download_video_download_failed));
    ...
    private void startRecordActivity(String path, int fps, int audioSampleRate) {
        ...
        Intent intent = new Intent(VideoPlayActivity.this, VideoShootingActivity.class);
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        protected PlayerInfo instantiatePlayerInfo(int position) {
            ...
            vodPlayer = new TXVodPlayer(VideoPlayActivity.this);
            ...
            vodPlayer.setVodListener(VideoPlayActivity.this);
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (tcLiveInfo.review_status.equals(TCVideoInfo.REVIEW_STATUS_PORN)) { //涉黄的图片不显示
                ...
                TCUtils.blurBgPic(VideoPlayActivity.this, coverImageView, tcLiveInfo.frontcover, R.mipmap.bg_ugc);
            }
            // 头像
            CircleImageView ivAvatar = (CircleImageView) view.findViewById(R.id.player_civ_avatar);
            Glide.with(VideoPlayActivity.this).load(tcLiveInfo.avatar).error(R.mipmap.face).into(ivAvatar);
            ...
            iv_heart_pic.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tv_heart_count.setText(tcLiveInfo.isLike ? String.valueOf((Long.parseLong(tcLiveInfo.likeCount) + 1))
...
//            iv_pause.setVisibility(View.INVISIBLE);
            ...
            ivAvatar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent m = new Intent(VideoPlayActivity.this, MyActivity.class);
