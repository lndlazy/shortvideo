package com.aaron.fpvideodemo.login;
...
//            String sig = getRequestSig(body);
            ...
            Request request = new Request.Builder()
                    .url(ApiService.APP_URL_NORMAL + cmd)
...
//    public void requestFormat(String cmd, JSONObject body, okhttp3.Callback callback) {
////        long now = System.currentTimeMillis() / 1000;
//        try {
////            String strBody = body.put("userid", mUserId)
////                    .put("timestamp", now)
