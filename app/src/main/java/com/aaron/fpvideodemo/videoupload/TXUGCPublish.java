package com.aaron.fpvideodemo.videoupload;
...
import com.aaron.fpvideodemo.videoupload.impl.TVCClient;
import com.aaron.fpvideodemo.videoupload.impl.TVCConstants;
import com.aaron.fpvideodemo.videoupload.impl.TVCUploadInfo;
import com.aaron.fpvideodemo.videoupload.impl.TVCUploadListener;
...
public class TXUGCPublish {
    ...
    public int publishVideo(TXUGCPublishTypeDef.TXPublishParam param) {
        ...
        Logger.d("封面：：：" + getFileType(coverPath) + ",:::" + coverPath);
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            if (mListener != null) {
                                ...
                                Logger.d("视频上传成功==>fileId::" + fileId + ",playUrl::" + playUrl + ",coverUrl::" + coverUrl);
