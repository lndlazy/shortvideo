package com.aaron.fpvideodemo.videoeditor.common.time;
...
import com.aaron.fpvideodemo.videoeditor.common.widget.videotimeline.SliderViewContainer;
...
public class TCTimeFragment extends BaseEditFragment implements View.OnClickListener {
    ...
    private void initViews(View view) {
        ...
        Glide.with(this).load(R.mipmap.motion_time_normal).into(mTvCancel);
        Glide.with(this).load(R.mipmap.motion_time_slow).into(mTvSpeed);
        Glide.with(this).load(R.mipmap.motion_time_repeat).into(mTvRepeat);
        Glide.with(this).load(R.mipmap.motion_time_reverse).into(mTvReverse);
    }
